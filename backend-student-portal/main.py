...
def create_app():
    app = Flask(__name__)
    CORS(app, resources={
    r"/auth/*": {"origins": "http://localhost:5173", "methods": ["POST", "GET", "OPTIONS", "DELETE", "PUT"], "allow_headers": ["Content-Type", "Authorization"]},
    r"/api/*": {"origins": "http://localhost:5173", "methods": ["POST", "GET", "OPTIONS", "DELETE", "PUT"], "allow_headers": ["Content-Type", "Authorization"]}
